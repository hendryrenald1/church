...
type SheetSide = keyof typeof sideClassNames;
...
>(({ className, children, side = "right", ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid gap-4 bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
        sideClassNames[side],
        className
      )}
      {...props}
